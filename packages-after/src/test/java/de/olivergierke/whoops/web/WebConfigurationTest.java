...
import de.olivergierke.whoops.account.web.AccountController;
import de.olivergierke.whoops.customer.web.CustomerController;

/**
 * Integration test to make sure the web configuration is working.
 * 
